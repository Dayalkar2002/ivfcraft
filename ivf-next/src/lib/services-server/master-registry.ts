...
export const MASTER_REGISTRY: MasterRegistryItem[] = [
...
export function getMasterRoute(item: MasterRegistryItem): string {
  switch (item.type) {
    case 'common':
...
export function getRegistryWithRoutes() {
...
export function getCommonMasterByCatId(catId: number) {
